...
const updatePrice = (id, value) => {
  const convertedOldPrice = Number(getInputValue(id));
  const convertPrice = Number(parseFloat(value));
...
const updateTotal = () => {
  const grandTotal =
    Number(parseFloat(getInputValue("price") + getInputValue("delivery-charge") +
